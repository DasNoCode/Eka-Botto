from pyrogram.types import InlineKeyboardMarkup,CallbackQuery,InlineKeyboardButton,ChatPermissions
...
class EventHandler:
    ...
    async def captcha(self, callback_data, M: Message):
        ...
        if captcha: #add db
         ...
         global msg
         msg = await self.__client.send_photo(M.chat.id,"out.png",caption=f"Kindly solve this captcha to message in this chat, you have 1 min!",reply_markup = keybord)
         os.remove("out.png")
        else:
